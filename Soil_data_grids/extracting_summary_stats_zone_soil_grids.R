...
# 
# # check extent of each raster some as misaligned and the stack wont run
# ext(maps_0_10)
# ext(maps_40_60)
# ext(DepthToClay)
# ext(DepthToFizz)
# ext(DepthToNeutral)
# ext(Force_map)
# ext(SurfaceRepelence)
# 
# # This is just seeing how much is not overlapping - I cant see much
# # raster_list <- list(maps_0_10, maps_40_60, DepthToClay, DepthToFizz, 
# #                     DepthToNeutral, Force_map, SurfaceRepelence)
# # 
# # names(raster_list) <- c("maps_0_10", "maps_40_60", "DepthToClay", "DepthToFizz",
# #                         "DepthToNeutral", "Force_map", "SurfaceRepelence")
# # 
...
# DepthToClay    <- resample(DepthToClay,    maps_0_10, method = "bilinear")
# DepthToFizz    <- resample(DepthToFizz,    maps_0_10, method = "bilinear")
# DepthToNeutral <- resample(DepthToNeutral, maps_0_10, method = "bilinear")
# Force_map      <- resample(Force_map,      maps_0_10, method = "bilinear")
# SurfaceRepelence <- resample(SurfaceRepelence, maps_0_10, method = "bilinear")
# 
# 
# raster_stack <- c(maps_0_10, 
#                   maps_40_60, 
