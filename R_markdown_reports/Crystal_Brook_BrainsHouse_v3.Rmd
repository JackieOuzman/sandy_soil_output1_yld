...
#              caption = "Met station information",
#              booktabs = TRUE)
...
```{r map of sites, echo=FALSE, warning=FALSE, fig.align='center', out.width='50%'}
...
```{r rain table 2 v3, echo=FALSE, message=FALSE, warning=FALSE}
...
#              caption = "Trial year's crop summary",
#              booktabs = TRUE,
#              longtable = FALSE) %>%
#   kable_styling(latex_options = c("hold_position", "scale_down")) %>%
...
knitr::kable(zones_table,
             ...
             caption = "Area and percentage of each zone.",
             booktabs = TRUE)
```
...
caption <- paste0("Max strip lenghth: ", strip_length, " m")



knitr::kable(summary_table %>% mutate(across(everything(), ~replace_na(as.character(.), ""))),
             caption = caption,
             col.names = c('Treatment', 'Zone 1', 'Zone 2', 'Zone 3','Zone 4','Total (ha)'),
             booktabs = TRUE)
