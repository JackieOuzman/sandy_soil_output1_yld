...
caption_text <- paste0("Trial Years Sowing and Rainfall Summary. \\\\ ",
                       "GS Period: ", gs_period, " \\\\ ",
                       "Summer Period: ", summer_period, " \\\\ ",
                       "Years Included: ", years_included)

knitr::kable(sowing_table %>% mutate(across(everything(), ~replace_na(as.character(.), ""))),
...
Note control strip was moved in 2025.
No samples were collected in new control, just the old control.


This analysis is using location of old control.
...
knitr::include_graphics(paste0(site_name, "_images/Yield data  jackie raw data.png"))
```
...
knitr::include_graphics(paste0(site_name, "_images/Yield data  jackie ladders.png"))
```
