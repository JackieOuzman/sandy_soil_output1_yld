...
knitr::include_graphics(paste0(site_name, "_images/sampling location jackie 2.png"))
...
**- Note at GUMS sample size is very low for Biomass at Flowering, use results with caution.**

**- Only one sample collected in B strips and removed from analysis.**
**- No samples were collected from RL strip** 
**- No TGW or protein results yet.**
...
**GUMS raw yield data has some very high values**
